...
def hello_world():
    ...
    return render_template('index.html', categories=list, video_cards=htmlItems.column_card("Big Bug Bunny", "380613d5-71b3-4f24-8a58-ca1a260b49d3", "http://34.125.25.53/mp4/bbb.mp4"))
